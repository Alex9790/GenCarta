...
public class Carga extends javax.swing.JFrame {
    ...
    public Carga(Planillas P) {  //Para poder llamar a "ProgresoCerrando" desde "Empleado"
        super();
        this.P = P;        
        initComponents();  
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/AjaxLoader.GIF"))); // NOI18N
        jPanel2.add(jLabel2);
        jLabel2.setBounds(130, 0, 128, 22);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(0, 230, 400, 20);
